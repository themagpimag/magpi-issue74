...
#include <GLES2/gl2.h>
#include "AssetManager.h" // OGL is the most likely to want to load lots of assets so we'll put our asset manager here
...
/*Now that we have created a type called a Target_State, we can use it in code.	We can create it here */
	...
	GLint FastTilePO;  // we are using a range of PO's now so this is for the tile
